...
import styles from './hero3Seas.module.scss'
  ...
  return (
    <section id='hero' className={classNames(block, styles)}>
      <div className={styles.backgrounds}>
        {block.backgrounds && block.backgrounds.map((background, i) => (
      ...
      <div onClick={scrollDown} className={styles.pageDownIconContainer}>
        {block.pageDownIcon && <Image className={styles.icon} images={images} src={block.pageDownIcon.image} title={block.pageDownIcon.title} alt={block.pageDownIcon.alt} />}
