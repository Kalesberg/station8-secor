...
import defaultStyles from './articlesGrid.module.scss'

export default ({ block, images, articles, pages, styles = defaultStyles, tag, limit = 10 }) => {
          ...
          return (
            <div key={i + article.fields.slug} className={styles.article}>
              ...
              <Link className={styles.buttonLink} to={link}>
                ...
                <img className={styles.arrow} src='' alt='Read Full Story' />
              </Link>
            </div>
          )
        })}
