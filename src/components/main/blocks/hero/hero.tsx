  ...
  return (
    <div className={styles.container}>
      {block.video && (
        ...
        <ReactPlayer wrapper={styles.hero} config={{wistia: {options: {endVideoBehavior: 'loop', volumeControl: false, fitStrategy: "cover"}}}} controls={false} url="https://station8branding.wistia.com/medias/lng6o2vfr1"/>
      )}
      {block.image && (
